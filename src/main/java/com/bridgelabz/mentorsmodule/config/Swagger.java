package com.bridgelabz.mentorsmodule.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.mentorsmodule.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("mentorsmodule",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("mentorsmodule", "http://bridgelabz.mentorsmodule", "swasthikkj@gmail.com"),
                "Apache 2.0",
